...
class WorkspaceTest < ActiveSupport::TestCase
  ...
  test "defaults to default country policy profile" do
    workspace = Workspace.create!(name: "Default Co", slug: "default-co", base_currency: "AUD")

    assert_equal "DEFAULT", workspace.country_code
  end
